• Addressing class imbalance in datasets through strategic under-sampling techniques and executing data preprocessing tasks to optimize the dataset for subsequent analysis.
